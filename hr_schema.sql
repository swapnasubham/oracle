...
CREATE TABLE regions (
	region_id NUMBER (11)  PRIMARY KEY,
	region_name varchar2(255)
	);
-- Done --

CREATE TABLE countries (
	country_id varchar2(255) PRIMARY KEY,
...
CREATE TABLE departments (
	department_id NUMBER (11)  PRIMARY KEY,
...
CREATE UNIQUE INDEX IDX_EMP_DATE on job_history(
	employee_id,
	start_date
	);
-- Done --
...
git branch -M main
git remote add origin git@github.com:swapnasubham/oracle.git
